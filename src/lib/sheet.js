...
function rowsFromCsv(text) {
  ...
  const iDate = idx("Date"), iEl = idx("Element"), iType = idx("Type (SKU/MULTI)"),
    iOffer = idx("Offer"), iUrl = idx("URL"), iPrice = idx("Discounted Price"),
    iHead = idx("Header"), iSub = idx("Subheader"), iStatus = idx("Status"),
    iCat = idx("Category");

  const missingCols = Object.entries({ Date: iDate, Element: iEl, "Type (SKU/MULTI)": iType, Offer: iOffer, URL: iUrl, "Discounted Price": iPrice, Subheader: iSub, Category: iCat })
